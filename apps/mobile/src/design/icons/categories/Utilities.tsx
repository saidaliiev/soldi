/**
 * Utilities — lightning bolt. Hand-drawn aesthetic (D-21): control points slightly
...
const STROKE = 1.6;
const PATH_D =
  'M13.4 4.4 L7.0 12.8 L11.6 12.8 L10.0 19.6 L17.0 10.6 L12.4 10.6 L13.4 4.4 Z';

export function Utilities({ color, size = 24 }: Props): React.JSX.Element {
