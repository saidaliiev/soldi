/**
 * Synthetic data source screen — STUB (plan 01-02).
 *
 * Full synthetic ingest logic lands in plan 01-03.
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      >
        <Text style={styles.title}>
          {t('onboarding.source_synthetic_title')}
        </Text>
        <Text style={styles.body}>
          {t('onboarding.source_synthetic_body')}
        </Text>
        <View style={styles.actions}>
          <PressableButton
            ...
            testID="synthetic-continue-button"
          />
        </View>
      </ScrollView>
    </SafeAreaView>
