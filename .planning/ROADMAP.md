...
- [ ] **Phase 5: Polish + TestFlight Beta** — Settings, biometric, notifications, performance, Internal TestFlight launch (2026-05-16: 05-01/02/03 code-complete; 05-04 Task 1 done [eas.json testflight profile + graceful observability]; 05-04 Tasks 2-3 BLOCKED human-action — TestFlight LAUNCH gated on P0 #3 Apple Developer enrollment + #4 eas init; device UAT items pending P0 #1. Mark [x] after TestFlight build uploaded + ≥1 internal tester runs it [D-04].)
