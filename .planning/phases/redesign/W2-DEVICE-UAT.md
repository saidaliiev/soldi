...
---
**Batched build also covers Wave 3 + Wave 4** — run `W3-DEVICE-UAT.md` and `W4-DEVICE-UAT.md` in the same device pass (one EAS build = W1+W2+W3+W4; user decision 2026-05-19).
